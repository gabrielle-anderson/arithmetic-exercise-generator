...
from MultiplicationSpecification import MultiplicationSpecification
...
class SpecificationReader:
    ...
    def getProblem(self, path, operation):
        ...
        return MultiplicationSpecification(firstOperandSpecification, secondOperandSpecification, resultExplicitRange, \
