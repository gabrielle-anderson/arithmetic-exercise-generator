class ProblemSpecification:
    ...
    def __eq__(self, other):
        return self.firstOperandSpecification == other.operand1 and self.secondOperandSpecification == other.operand2 \
               and self.adjustments == other.adjustments and self.adjustingOptional == other.adjustingOptional
    ...
    def randomOperands(self):
        ...
        adjustments = self.digitAdjustments(firstOperand, secondOperand)

        validAdjustments = True
        for digit in self.adjustments.keys():
            validAdjustments = validAdjustments and (self.adjustments[digit] == adjustments[digit])
